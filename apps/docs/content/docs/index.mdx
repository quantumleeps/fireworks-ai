...
<Video src="/videos/chess-duel.mp4" autoPlay loop muted playsInline />
...
| | | |
|:---:|:---:|:---:|
| <Img src="/images/edit-diff.png" alt="Edit widget showing red/green diff" /> | <Img src="/images/websearch.png" alt="WebSearch widget with favicon pills" /> | <Img src="/images/bash-widget.png" alt="Bash widget" /> |
| **Edit** — red/green diffs | **WebSearch** — favicon pills | **Bash** — command + output |
| <Img src="/images/todowrite-widget.png" alt="TodoWrite widget" /> | <Img src="/images/thinking.png" alt="Thinking block" /> | <Img src="/images/permission-card.png" alt="Permission card" /> |
| **TodoWrite** — progress checklist | **Thinking** — extended reasoning | **Approval** — Allow/Deny gates |

See all 11 widgets in the [Built-in Widgets guide](/docs/built-in-widgets).
...
<Img src="/images/code-workbench.png" alt="Code workbench — split-pane coding assistant with live preview" />

The spirograph studio above was built by Opus 4.6 using the [code-workbench](https://github.com/quantumleeps/neeter/tree/main/examples/code-workbench) example — a split-pane coding assistant with live preview, per-session sandboxes, file checkpointing, and session resume.
