...
description: The 11 SDK tool widgets that ship with @neeter/react and how to override them
---
...
<Img src="/images/websearch.png" alt="WebSearch widget with favicon source pills" width={600} />
...
<Img src="/images/edit-diff.png" alt="Edit widget: line-by-line diff with approval controls" width={600} />
...
<Img src="/images/bash-widget.png" alt="Bash widget: command + output with green status dot" width={600} />
...
<Img src="/images/webfetch-widget.png" alt="WebFetch widget: favicon pill with markdown-rendered page content" width={600} />
...
<Img src="/images/todowrite-widget.png" alt="TodoWrite checklist with status icons and progress tracking" width={600} />
...
Source files: [`packages/react/src/widgets/*Widget.tsx`](https://github.com/quantumleeps/neeter/tree/main/packages/react/src/widgets)

## Next steps

To register widgets for your own MCP tools or app-specific rendering, see [Custom Widgets](/docs/custom-widgets).
